...
![Full mbed process](/Getting_Started/Images/fullmbedprocess.png "The standard process is to get a board (and maybe a few extending components), write a bit of code and import it to the board. Simple.")
</span>
...
3. [Working with the mbed compiler, and a few words about APIs](/Getting_Started/IDE_API/).
